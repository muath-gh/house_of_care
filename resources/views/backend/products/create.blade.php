    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card shadow mb-4">
                {!! Form::open(['url' => url('admin/products'), 'method' => 'post', 'files' => true]) !!}
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        {!! Form::number('product_price', old('product_price'), ['class' => 'form-control', 'placeholder' => 'Product Price']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        {!! Form::textarea('product_desc', old('product_desc'), ['class' => 'form-control', 'placeholder' => 'Product Description']) !!}
